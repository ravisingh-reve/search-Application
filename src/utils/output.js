...
exports.setOutput = async function setOutput(resultsPath) {
  ...
  core.setOutput('summaryData', manifestResults ? manifestResults[0]?.summary : '')
  core.setOutput('jsonPath', manifestResults ? manifestResults[0]?.jsonPath : '')
  core.setOutput('htmlPath', manifestResults ? manifestResults[0]?.htmlPath : '')
  core.setOutput('actualUrl', manifestResults ? manifestResults[0]?.url : '') 
}
